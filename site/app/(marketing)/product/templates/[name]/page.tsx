...
export async function generateMetadata({
  ...
  const description = `${t.tagline} Compiled by Project Spine into AGENTS.md, CLAUDE.md, copilot-instructions, scaffold plan, QA guardrails, and a sprint-1 backlog.`;
