...
### 1. Consolidate the web app and shared UI package into one workspace.

**Detail:** Deliver: Consolidate the web app and shared UI package into one workspace.
...
### 2. Cut CI time with affected-only builds and cached task outputs.

**Detail:** Deliver: Cut CI time with affected-only builds and cached task outputs.
...
### 3. Share a typed UI package without allowing apps to become package depe…

**Detail:** Deliver: Share a typed UI package without allowing apps to become package dependencies.
