...
### 1. Ship a role-aware operations dashboard for support leads within 8 weeks.

**Detail:** Deliver: Ship a role-aware operations dashboard for support leads within 8 weeks.
...
### 2. Reduce manual queue triage by surfacing priority accounts and stale c…

**Detail:** Deliver: Reduce manual queue triage by surfacing priority accounts and stale cases.
...
### 3. Give managers exportable weekly metrics without ad-hoc SQL requests.

**Detail:** Deliver: Give managers exportable weekly metrics without ad-hoc SQL requests.
